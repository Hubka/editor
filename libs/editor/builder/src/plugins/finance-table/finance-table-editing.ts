...
export default class FinanceTableEditing extends Plugin {
   init() {
      ...
      this.editor.commands.add(insertCommandName, new InsertFinanceTableCommand(this.editor));
   }
   ...
   _defineSchema() {
      ...
      schema.addChildCheck((context, childDefinition) => {
         if (context.endsWith('simpleBoxDescription') && childDefinition.name == parentElName) {
            return false;
         }
      });
   }
